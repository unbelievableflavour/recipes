...
public class RecipeFileManager : Object {
    ...
    public Recipe[] get_recipes_from_json () {
        ...
        var message = new Soup.Message (
            "GET",
            "https://raw.githubusercontent.com/bartzaalberg/recipes/master/recipes/new-recipes.json"
        );
    ...
    private Recipe[] translate_json_to_recipes (Json.Parser parser) {
        ...
        foreach (unowned Json.Node item in array.get_elements ()) {
            ...
            if (recipe_language != "en") {
                if (object.get_member ("title").get_object ().has_member ("nl") ) {
                    recipe.set_name (object.get_member ("title").get_object ().get_string_member ("nl"));
                }
            }
